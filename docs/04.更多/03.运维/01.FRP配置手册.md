...
## 架构
![架构图](https://img.whalenas.com:283/image/20210123153642.png)
...
[frps 完整配置文件](https://github.com/fatedier/frp/blob/dev/conf/frps_full.ini)
...
![Dashboard](https://img.whalenas.com:283/image/20210123161231.png)
...
如果想要在外网环境访问 Admin UI，将 `7400 端口`映射出去即可，但需要重视安全风险。
